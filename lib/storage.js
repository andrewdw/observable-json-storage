...
exports.set = function(key, value) {
  var writeFileStream = Rx.Observable.bindCallback(fs.writeFile);
  // return save chain
...
exports.get = function(key) {
  var readFileStream = Rx.Observable.bindCallback(fs.readFile);
  return utils.getFilePath(key)
    .concatMap(function(filePath) {
...
exports.has = function(key) {
  var hasFileStream = Rx.Observable.bindCallback(fs.stat);
  return utils.getFilePath(key)
    .concatMap(function(filePath) {
...
exports.remove = function(key) {
  var removeFileStream = Rx.Observable.bindCallback(rimraf);
  return utils.getFilePath(key)
    .concatMap(function(filePath) {
